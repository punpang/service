        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!(_this.goods.text == "" || _this.goods.price == "" || _this.goods.pos_category_goods_id == "" || _this.goods.status_use == "" || _this.goods.id == "" && _this.propGoods)) {
                  _context.next = 3;
                  break;
                }
                _this.$swal({
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!(_this.category_goods.text == "" || _this.category_goods.status_use == "" || _this.category_goods.id == "" && _this.propCategoryGoods)) {
                  _context.next = 3;
                  break;
                }
                _this.$swal({
