          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _this2.op1 = _this2.data.id;
                _this2.subs1 = [{
                  id: _this2.data.id,
                  name: _this2.data.name
                }];
                _this2.form.subs1 = _this2.data.id;
                _this2.form.product_id = _this2.data.id;
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3() {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                if (!_this3.$refs.formOP12.validate()) {
                  _context3.next = 5;
                  break;
                }

                _context3.next = 3;
                return _this3.$store.dispatch("optionMain/store", _this3.form);

              case 3:
                res = _context3.sent;

                if (res.status === 200) {
                  _this3.$toast.success("ทำรายการสำเร็จ");
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _this4.op2 = null;
                _this4.form.subs2 = null;
                return _context4.abrupt("return");

              case 6:
                _context4.next = 8;
                return _this4.$store.dispatch("productCategory/getSubByID", _this4.op1);

              case 8:
                res = _context4.sent;
                _this4.subs1 = res.data;
                _this4.form.subs1 = null;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                dataCheck = {
                  subs1: _this5.form.subs1,
                  product_id: _this5.data.id
                };
                _context5.next = 3;
                return _this5.$store.dispatch("optionMain/check", dataCheck);

              case 3:
                resCheck = _context5.sent;
                ...
                _this5.form.subs1 = null;

                _this5.$toast.error("โปรดเลือกใหม่");
              ...
              case 8:
                ...
                for (i = 0; i < resCheck.data.data.sub.length; i++) {
                  _this5.form.subs2[i] = resCheck.data.data.sub[i].op2;
                }

                _this5.op2 = resCheck.data.data.product_category_id;
                _this5.form.op1 = resCheck.data.data.id;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                if (!(_this6.op2 == _this6.op1)) {
                  _context6.next = 5;
                  break;
                }

                _this6.$toast.warning("ตัวเลือกหลัก ห้ามซ้ำกัน");

                _this6.op2 = null;
                _this6.form.subs2 = null;
                return _context6.abrupt("return");

              case 5:
                _this6.form.product_category_id = _this6.op2;
                _context6.next = 8;
                return _this6.$store.dispatch("productCategory/getSubByID", _this6.op2);

              case 8:
                res = _context6.sent;
                _this6.subs2 = res.data;
          ...
          _c(
            ...
            [
              _c(
                ...
                { staticClass: "pb-0" },
                [
                  _c("h3", { on: { click: _vm.clickProduct } }, [
                    _vm._v("ชื่อสินค้า : " + _vm._s(_vm.data.name))
                  ]),
                  _vm._v(" "),
                  _c("v-spacer"),
                  _vm._v(" "),
