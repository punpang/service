        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this.fetch_categort_goods();
              case 2:
              case "end":
                return _context.stop();
            }
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                payload = "raw=true";
                _context2.next = 4;
                return _this2.$store.dispatch("posCategoryGoods/fetch", payload).then(function (response) {
                  _this2.$swal({
                    toast: true,
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return _this3.fetch_categort_goods();
            case 2:
            case "end":
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                payload = "raw=true";
                _context2.next = 4;
                return _this2.$store.dispatch("posGoods/fetch", payload).then(function (response) {
                  _this2.$swal({
                    toast: true,
                    title: "โหลดข้อมูลสำเร็จ",
                    icon: "success",
