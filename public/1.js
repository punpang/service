...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    emitClickMenu: function emitClickMenu() {
      this.menu = !this.menu;
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _js_components_google_drive_imageThumbnail__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/js/components/google/drive/imageThumbnail */ "./resources/js/components/google/drive/imageThumbnail.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ["order_id"],
  components: {
    imageThumbnail: _js_components_google_drive_imageThumbnail__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: function data() {
    return {
      details: {}
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _this.$store.dispatch("orderDetail/getByOrderID", _this.order_id);

            case 2:
              _context.next = 4;
              return _this.$store.getters["orderDetail/getByOrderId"];

            case 4:
              _this.details = _context.sent;
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c(
                        ...
                        [
                          _c("OrderShow", {
                            attrs: { order_id: _vm.order.id },
                            on: { emitClickMenu: _vm.emitClickMenu }
                          })
                        ],
                        1
                      ),
                                        ...
                                        directives: [
                                          {
                                            name: "show",
                                            rawName: "v-show",
                                            value: _vm.product.id >= 1,
                                            expression: "product.id >= 1"
                                          }
                                        ],
                                        attrs: {
                                          width: "auto",
        ...
        [
          _c(
            ...
            [
              ...
              _c("v-spacer"),
              _vm._v(" "),
              _c("v-icon", { on: { click: _vm.clickMenu } }, [_vm._v("dehaze")])
            ],
            1
          ),
          _vm._v(" "),
                      ...
                      [
                        ...
                        _c(
                          ...
                          [
                            _c("p", [
                              _vm._v(
                                "ร่าคา " + _vm._s(detail.price) + ".00 บาท"
                              )
                            ]),
                            _vm._v(" "),
                            _vm._l(
