          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                form = {
                  count: _this.formCount,
                  priceRange: _this.formPriceRange,
                  tableNumber: _this.dataTable.id
                };

                if (!(_this.$refs.form.validate() && _this.formCount.sumCountCustomer > 0)) {
                  _context.next = 10;
                  break;
                }
          ...
          _c(
            ...
            [
              _c(
                ...
                [
                  _c("countCustomer", {
                    attrs: { propformCount: _vm.formCount }
                  }),
                  _vm._v(" "),
                  _c("v-divider"),
                  _vm._v(" "),
    ...
    [
      ...
      _c(
        "v-radio-group",
        {
          ...
          model: {
            value: _vm.formPriceRange,
            callback: function($$v) {
              _vm.formPriceRange = $$v
            },
            expression: "formPriceRange"
          }
        },
