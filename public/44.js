...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ["propGoods", "propOrder", "propOrderUpdate", "propOrderDetail", "propOrderDetailUpdate"],
  data: function data() {
    return {
      count: 1,
      price: 0
            ...
            switch (_context.prev = _context.next) {
              case 0:
                payload = {
                  count: _this.count,
                  price: _this.price,
                  sum_price: _this.sum_price
                };
                dispatch = "";
                if (_this.propOrder) {
                  payload.order_id = _this.propOrder.id;
                  dispatch = "orderPos/store";
                }
                if (_this.propOrderUpdate) {
                  payload.id = _this.propOrderUpdate.id;
                  dispatch = "orderPos/update";
                }
                if (_this.propOrderDetail) {
                  payload.order_detail_id = _this.propOrderDetail.id;
                  dispatch = "orderDetailPos/store";
                }
                if (_this.propOrderDetailUpdate) {
                  payload.id = _this.propOrderDetailUpdate.id;
...
var render = function render() {
  ...
  }, [_c("v-icon", [_vm._v("add")])], 1)], 1)], 1)], 1)], 1), _vm._v(" "), _vm.propOrderUpdate != null || _vm.propOrderDetailUpdate != null ? _c("v-card-actions", [_c("v-btn", {
  ...
  }, [_vm._v("\n                บันทึก (" + _vm._s(_vm._f("formatNumber")(_vm.sum_price)) + "฿)\n            ")])], 1)], 1)], 1);
};
var staticRenderFns = [];
render._withStripped = true;
  ...
  return _c("div", [_c("v-row", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref5) {
        ...
        }, [_vm.propOrder ? _c("selectForOrder", {
          attrs: {
            propGoods: item,
            propOrder: _vm.propOrder
          }
