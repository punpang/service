...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    titleProduct: function titleProduct(product_id) {
      var products = this.countProducts.products;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                if (_this3.$refs.formPaymentOnline.validate()) {
                  _context3.next = 2;
                  break;
                }
              ...
              case 2:
                ...
                _context3.next = 5;
                return _this3.$store.dispatch("payment/confirmOnline", _this3.form);
              ...
              case 5:
                ...
                _context3.next = 9;
                return _this3.$store.dispatch("promotion/fetchAllByID", {
                ...
                [
                  ...
                  _c("v-simple-table", [
                    ...
                    _c(
                      "tbody",
                      [
                        _vm._l(_vm.countProducts.count, function(count, index) {
