...
var render = function render() {
  ...
  return _c("div", [_c("v-dialog", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref) {
        ...
        return [_c("v-list-item", _vm._g({}, on), [_c("v-list-item-icon", [_c("v-icon", [_vm._v("local_atm")])], 1), _vm._v(" "), _c("v-list-item-content", {
          ...
          staticClass: "py-2"
        }, [_vm._v("บริการล้อม/ลูกบอล/ซ่อนเงิน")])], 1)], 1)];
      }
    }]),
    model: {
      value: _vm.dialog,
  ...
  }, [_vm._v("\n                        หมายเหตุ : " + _vm._s(_vm.cash.remark) + "\n                    ")]) : _vm._e(), _vm._v(" "), _vm.option ? _c("div", [_c("v-divider"), _vm._v(" "), _c("v-text-field", {
    staticClass: "mb-3",
    attrs: {
      label: "แบงค์ 20 บาท",
      outlined: "",
    ...
    staticClass: "mb-0"
  }), _vm._v(" "), _c("v-simple-table", [_c("tbody", [_c("tr", [_c("td", [_vm._v("จำนวนแบงค์")]), _vm._v(" "), _c("td", {
    staticClass: "text-right"
  }, [_vm._v("\n                                        " + _vm._s(_vm.cashSum > 0 ? _vm.cashSum : "") + "\n                                        แบงค์\n                                    ")])]), _vm._v(" "), _c("tr", [_c("td", [_vm._v("จำนวนเงิน")]), _vm._v(" "), _c("td", {
    staticClass: "text-right"
    ...
    staticClass: "text-right"
  }, [_vm._v("\n                                        " + _vm._s(_vm._f("formatNumber")(_vm.cashTotal)) + "\n                                        บาท\n                                    ")])])])])], 1) : _vm._e()], 1), _vm._v(" "), _c("v-card-actions", [_c("v-btn", {
    staticClass: "error",
    on: {
      click: function click($event) {
        return _vm.exit();
    ...
    staticClass: "success",
    attrs: {
      disabled: _vm.cashSum <= 0 || _vm.thbSum <= 0
    },
    on: {
      click: function click($event) {
