...
class ProductTableSeed extends Seeder
{
    ...
    {
        $products = [
            ["id"=>"10001","name" => "ฝอยทอง", "price_normal" => 200, "price_special_status" => 0, "price_special" => 200.00, "status" => 1, "image_status" => 1, "product_image_id" => 1],
            ["id"=>"10002","name" => "มะพร้าวอ่อน", "price_normal" => 420, "price_special_status" => 1, "price_special" => 370.00, "status" => 1, "image_status" => 1, "product_image_id" => 2]
        ];
        $images = [
