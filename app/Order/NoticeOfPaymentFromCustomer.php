...
class NoticeOfPaymentFromCustomer extends Model
{
    ...
    public static function setSuccessFromVerifySlipV4($qr_code_text, $notice)
    {
        Linenotify::send("setSuccessFromVerifySlipV4 :: 1");

        $verify_slip = Helper::verify_slip_v4($qr_code_text, $notice->amount);
        // Linenotify::send('$verify_slip = Helper::verify_slip($result);');
