    ...
    methods: {
        ...
        async start() {
            ...
            if (response.status == 200) {
                ...
                SCBPayment = await axios.get(
                    "/api/v1/guest/scbpayment/" + this.amount + "/" + this.order.id + "/" + this.order.customer_id + "/deeplinkUrl" 
                );
                this.deeplink = SCBPayment.data.data.deeplinkUrl;
