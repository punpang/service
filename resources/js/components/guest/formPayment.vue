      ...
      <v-card>
        ...
        <v-card-text>
          <v-card outlined class="mb-2 mt-2">
            <v-card-text>
              <strong class="black--text">ยอดที่ต้องการชำระ</strong>
              <v-text-field
              ...
              >
                <v-chip
                  @change="changeAmountDeposit(optionAmount.id)"
              ...
              <strong class="error--text" v-if="order.status_full_payment"
                ...
                <v-container>
                  <v-row>
                    <v-col
                      ...
                      sm="6"
                      lg="3"
                      @click="clickChannel(paymentChannel)"
                    >
                      <v-item v-slot="{ active, toggle }">
                        <v-card
                          ...
                          :disabled="
                            ...
                            deposit < paymentChannel.minimum
                          "
                        >
                          ...
                          >
                            ...
                            <h6 class="mb-0">
                              ...
                              >
                              <strong
                                v-else-if="!paymentChannel.status_use"
                                class="red--text"
                              ...
                              <strong
                                ...
                                >ยอดชำระขั้นต่ำ
                                {{ paymentChannel.minimum }} บาท</strong
                              >
                            </h6>
                          </v-card-text>
                        </v-card>
