      ...
      <v-card-text>
        <v-row>
          <v-col cols="6" class="py-1">
              ...
              <!-- <div class="mb-0" v-if="propProducts">
                ( {{ propProducts.length }} ชิ้น )
              </div> -->
          </v-col>
          <v-col cols="6 " class="text-right py-1">
            <strong
              >฿{{
                parseFloat(propSum.sum_price_normal) | formatNumber
              }}</strong
            >
          </v-col>
        </v-row>
        ...
        <v-row>
          ...
          <v-col cols="6" class="text-right py-1">
            <strong class="red--text"
              >฿{{ parseFloat(propSum.sum_discount) | formatNumber }}</strong
            >
          </v-col>
        </v-row>
        ...
        <v-row>
          ...
          <v-col cols="6" class="text-right py-1">
            <strong
              >฿{{
                parseFloat(propSum.sum_price_special) | formatNumber
              }}</strong
            >
          </v-col>
        </v-row>
