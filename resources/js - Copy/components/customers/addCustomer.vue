<template>
 <v-row>
            ...
            <v-card>  
                ...
                <v-card-text>
                    ...
                    >
                        ...
                        append-icon="phone"></v-text-field>   
                    </v-form>

                </v-card-text>
                <v-card-actions>
                    <v-btn color="success" @click="submit" :loading='loadingSubmit'><v-icon left>save</v-icon>เพิ่มลูกค้าใหม่</v-btn>  
                    <v-btn color="error" @click="reset"><v-icon left>refresh</v-icon>ล้างข้อมูล</v-btn>                                   
                </v-card-actions>
            </v-card>            
        </v-dialog> 
    </v-col>       
    ...
    <v-snackbar right v-model="snackbar.on" :color="snackbar.color">{{snackbar.text}}</v-snackbar>
