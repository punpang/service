        ...
        <v-row justify="center">            
            ...
            md="4">
                <v-text-field 
                    ...
                    autofocus 
                    :rules="rules.email"
                    append-icon="perm_identity"></v-text-field>
            ...
            submitLogin() {
                if(this.$refs.loginForm.validate()){
                    ...
                    axios.post('/api/auth/login', {
                        ...
                        {
                            this.snackbar.login.text = 'ลองอีกครั้ง ! ไม่สามารถเชิ่อมต่อไปยังเซิร์ฟเวอร์ได้'
                            this.snackbar.login.color = 'warning'
                        }else{  
                            this.snackbar.login.text = 'ไม่สามารถเข้าสู่ระบบได้ กรุณาลองอีกครั้งค่ะ'
                        }
