...
const routes = [
  ...
  },
  {
    path: '/customers',
    name: 'Customers',
    component: () => import('@/js/pages/orders/customers/index'),
    meta: { requiresAuth: true }
  },
  {
    path: '/about',
    name: 'About',
    component: () => import(/* webpackChunkName: "about" */ '@/js/views/About'),
    meta: { requiresAuth: true }
  },
  {
    path: '/form',
  ...
  },
  {
    path:'/order',
    name:'Order',
    component: () => import(/* webpackChunkName: "about" */ '@/js/views/Orders'),
    meta: { requiresAuth: true }
  },
  {
      path: '/dashboard',
