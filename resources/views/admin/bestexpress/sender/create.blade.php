...
{!! Form::open(['method' => 'POST' , 'action' => 'BestExpress\SenderController@store']) !!}

@include('admin.bestexpress.sender._form' , ['header_name' => 'สร้างรายชื่อผู้ส่งใหม่' ,'btnname' => 'สร้างรายชื่อ' ,'btnclass' => 'btn-best shadow'])
